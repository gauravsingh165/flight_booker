...
ActiveRecord::Schema[7.0].define(version: 2023_08_10_132144) do
  create_table "airports", charset: "utf8mb3", force: :cascade do |t|
    t.string "code"
  ...
  create_table "passengers", charset: "utf8mb3", force: :cascade do |t|
